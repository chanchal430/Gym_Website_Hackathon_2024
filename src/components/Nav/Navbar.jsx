      ...
      >
        <Link to="/" className="flex">
          ...
          <div className="text-start">
            <h1 className="text-[20px] lg:text-[30px] text-white font-bold underline">
              Gymantrum
            </h1>
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  <Link to="/" className="flex cursor-pointer">
                    <img src={Logo} alt="logo_img" className="w-[52px]" />
                    <div className="text-start">
                      <h1 className="text-[24px] text-black font-bold underline">
                        Gymantrum
                      </h1>
